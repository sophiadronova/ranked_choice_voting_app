...
public class VotingForm {
    ...
    public static JPanel CreateVotingForm () {
        Color maroon = new Color(128, 0, 0);
        Color white = Color.WHITE;

        JPanel panel = PanelUtils.createVerticalPanel();
        panel.setBorder(BorderFactory.createEmptyBorder(15, 15, 15, 15));

        // TITLE
        JPanel titlePanel = PanelUtils.createHorizontalPanel();
        ...
        // INSTRUCTIONS
        JPanel instructionsPanel = PanelUtils.createVerticalPanel();
        ...
        JPanel inputPanel = PanelUtils.createHorizontalPanel();

        Dimension textFieldSize = new Dimension(300, 30);

        // VOTER ID INPUT
        JPanel idPanel = PanelUtils.createVerticalPanel();
        ...
        JPanel pinPanel = PanelUtils.createVerticalPanel();
        ...
        for (int i = 0; i < 3; i++) {
            JPanel rowPanel = PanelUtils.createHorizontalPanel();
        ...
        // BUTTONS
        JPanel buttonsPanel = PanelUtils.createHorizontalPanel();
        ...
        // new button to create new form for retrieving ballot
        JButton retrieveButton = new JButton("Retrieve Ballot");
        ...
        // SUMMARY
        JPanel summaryPanel = PanelUtils.createVerticalPanel();
